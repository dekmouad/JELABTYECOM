            ...
            <Wrapper>
                <Left>
                    <Link to="/" style={{color: "black", textDecoration: "none"}}>
                        <Logo>JELABTY</Logo> </Link>
                </Left>
                <Center>
                    <SearchContainer>
                        <Input placeholder="Search" onChange={search ? search : handelChangeRecherche}/>
                ...
                <Right>
                    ...
                    {utilisateur ?
                        <MenuItem style={{color: "black"}} onClick={clickDeconnecter}><b>Disconnect</b></MenuItem>
                        :
                        <A>
